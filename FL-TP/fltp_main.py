...
from models import MLP, CNNMnist, CNNFashion_Mnist, CNNCifar,LSTM_CNN, Transformer
...
if __name__ == '__main__':
    ...
    if args.model == 'LSTM':
        ...
        global_model = Transformer(input_size=x.shape[2], output_size=y.shape[2], hidden_size=64)
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        # 保存csv
        with open("add_weights_meterError_transformer.csv", "a") as csvfile:
