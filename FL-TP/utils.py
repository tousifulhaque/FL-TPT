...
class TrajectoryDataset(Dataset):
    ...
    def __init__(self, csv_file='../data/result.csv'):
        """
            Args:
    ...
    def load_data(self):
        dataS = pd.read_csv(self.csv_file, encoding='utf-8')
...
def get_dataset(args):
    ...
    # print(len(trainDataset.dataset.X_frames))
    # print(testDataset.__len__())
    user_groups = VeRemi_iid(trainDataset,args.num_users,dataset)
